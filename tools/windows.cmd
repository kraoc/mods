...
:UpdateFerium
    ...
    cd tools\
		...
		powershell.exe -ExecutionPolicy Unrestricted -WindowStyle Maximized -Command "wget $FeriumApp -o ferium.exe"
    cd ..
exit /b 0
...
:UpdateDatas
    ...
    cd datas\
		...
		powershell.exe -ExecutionPolicy Unrestricted -WindowStyle Maximized -Command "wget $ListVersion -o version.txt"
		powershell.exe -ExecutionPolicy Unrestricted -WindowStyle Maximized -Command "wget $ListModrinth -o modrinth.txt"
		powershell.exe -ExecutionPolicy Unrestricted -WindowStyle Maximized -Command "wget $ListCurseforge -o curseforge.txt"
    cd ..
exit /b 0
