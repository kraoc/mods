...
:UpdateFerium
	...
	powershell.exe -ExecutionPolicy Unrestricted -WindowStyle Maximized -Command "Invoke-WebRequest -Headers @{'Cache-Control'='no-cache'} $FeriumApp -o ferium.exe"
    cd ..
exit /b 0
...
:UpdateDatas
	...
	powershell.exe -ExecutionPolicy Unrestricted -WindowStyle Maximized -Command "Invoke-WebRequest -Headers @{'Cache-Control'='no-cache'} $ListVersion -o version.txt"
	powershell.exe -ExecutionPolicy Unrestricted -WindowStyle Maximized -Command "Invoke-WebRequest -Headers @{'Cache-Control'='no-cache'} $ListModrinth -o modrinth.txt"
	powershell.exe -ExecutionPolicy Unrestricted -WindowStyle Maximized -Command "Invoke-WebRequest -Headers @{'Cache-Control'='no-cache'} $ListCurseforge -o curseforge.txt"
    cd ..
exit /b 0
