...
:UpdateFerium
	...
	powershell.exe -Command "Invoke-WebRequest -DisableKeepAlive -Headers @{'Cache-Control'='no-cache, no-store, must-revalidate'; 'Pragma'='no-cache'; 'Expires'='0'} https://github.com/kraoc/mods/raw/main/tools/ferium.exe -o ferium.exe"
    cd ..
exit /b 0
...
:UpdateDatas
	...
	powershell.exe -Command "Invoke-WebRequest -DisableKeepAlive -Headers @{'Cache-Control'='no-cache, no-store, must-revalidate'; 'Pragma'='no-cache'; 'Expires'='0'} https://github.com/kraoc/mods/raw/main/lists/version.txt -o version.txt"
	powershell.exe -Command "Invoke-WebRequest -DisableKeepAlive -Headers @{'Cache-Control'='no-cache, no-store, must-revalidate'; 'Pragma'='no-cache'; 'Expires'='0'} https://github.com/kraoc/mods/raw/main/lists/client_modrinth.txt -o modrinth.txt"
	powershell.exe -Command "Invoke-WebRequest -DisableKeepAlive -Headers @{'Cache-Control'='no-cache, no-store, must-revalidate'; 'Pragma'='no-cache'; 'Expires'='0'} https://github.com/kraoc/mods/raw/main/lists/client_curseforge.txt -o curseforge.txt"
    cd ..
exit /b 0
