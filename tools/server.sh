...
function UpdateFerium() {
    ...
    cd tools/
        ...
        wget --header="Cache-Control=no-cache, no-store, must-revalidate; Pragma=no-cache; Expires=0" --output-document=ferium --no-clobber --no-dns-cache --inet4-only --no-cache --no-cookies --no-check-certificate --recursive $FeriumApp >/dev/null 2>&1
    cd ..
}
...
function UpdateDatas() {
    ...
    cd datas/
        ...
        wget --header="Cache-Control=no-cache, no-store, must-revalidate; Pragma=no-cache; Expires=0" --output-document=version.txt --no-clobber --no-dns-cache --inet4-only --no-cache --no-cookies --no-check-certificate --recursive $ListVersion >/dev/null 2>&1
        wget --header="Cache-Control=no-cache, no-store, must-revalidate; Pragma=no-cache; Expires=0" --output-document=modrinth.txt --no-clobber --no-dns-cache --inet4-only --no-cache --no-cookies --no-check-certificate --recursive $ListModrinth >/dev/null 2>&1
        wget --header="Cache-Control=no-cache, no-store, must-revalidate; Pragma=no-cache; Expires=0" --output-document=curseforge.txt --no-clobber --no-dns-cache --inet4-only --no-cache --no-cookies --no-check-certificate --recursive $ListCurseforge >/dev/null 2>&1
    cd ..
}
